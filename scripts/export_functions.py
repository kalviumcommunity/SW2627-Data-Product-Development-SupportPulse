...
def markdown_to_simple_html(markdown_text):
    """
    Convert basic Markdown text into simple HTML.
    """
...
def create_metadata(df, report_dir):
    """
    Create metadata README for the exported report.
    """
    ...
    with open(
        ...
        file.write("# SupportPulse Analysis Export\n\n")
...
def export_analysis(
    ...
    """
    Export SupportPulse analysis into:
